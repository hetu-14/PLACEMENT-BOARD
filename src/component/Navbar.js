...
export default function Navbar({ user, setLoginUser }) {
  ...
  return (
    <Disclosure as="nav" className="bg-[#A7BEAE]">
      {({ open }) => (
        <>
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <img
                    ...
                    src="https://i.ibb.co/wJ9kwFZ/logo-removebg-preview.png"
                    alt="Your Company"
                  />
                </div>
                  ...
                  <div>
                    <Menu.Button className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <img
                        ...
                        src="https://cdn3d.iconscout.com/3d/premium/thumb/student-male-7267574-5914564.png?f=webp"
                        alt=""
                      />
                    </Menu.Button>
                  </div>
